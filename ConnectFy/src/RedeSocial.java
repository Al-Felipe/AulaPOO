...
public class RedeSocial {
    ...
    private void enviarMensagem() {
        if (usuarioAtual != null) {
            String nomeAmigo = JOptionPane.showInputDialog(null,"Digite o nome do amigo para enviar a mensagem:", "ConnectFy", JOptionPane.QUESTION_MESSAGE);
            Usuarios amigo = null;
            ...
            if (amigo != null && usuarioAtual.eAmigo(amigo)) {
                ...
                JOptionPane.showMessageDialog( null, "Amigo não encontrado ou não " +
                        "está na sua lista de amigos.", "ConnectFy", JOptionPane.ERROR_MESSAGE);
        }
    }
